...
define(["require", "exports", "WoltLabSuite/Core/Ajax/Backend", "WoltLabSuite/Core/Api/Result"], function (require, exports, Backend_1, Result_1) {
    ...
    exports.markAllConversationsAsRead = markAllConversationsAsRead;
    async function markAllConversationsAsRead() {
        try {
            await (0, Backend_1.prepareRequest)(`${window.WSC_RPC_API_URL}core/conversations/mark-all-as-read`).post().fetchAsJson();
        }
        catch (e) {
